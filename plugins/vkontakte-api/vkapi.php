...
/*
	Copyright 2011  Euvgen Zabrodski  (email: kowack@gmail.com)
...
<script type=\"text/javascript\">
    ...
    function post_publish( $new_status, $old_status, WP_Post $post ) {
        // check status
        ...
        if ( ! empty( $temp1 ) && ! empty( $temp2 ) ) {
            ...
            <label>
                <input type="checkbox"
                    ...
                    />
            </label> <?php _e( 'Show Post link:', $this->plugin_domain ); ?>
            </div><?php } else { ?>
            <div class="misc-pub-section">
...
class VKAPI_Login extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array(
            'classname'   => 'widget_vkapi',
            'description' => __( 'Login widget', $this->plugin_domain )
        );
...
class VKAPI_Comments extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array(
            'classname'   => 'widget_vkapi',
            'description' => __( 'Last Comments', $this->plugin_domain )
        );
...
class FBAPI_LikeBox extends WP_Widget {
    ...
    function __construct() {
        add_action( 'vkapi_body', array( 'VK_api', 'js_async_fbapi' ) );
        load_plugin_textdomain( $this->plugin_domain, false, dirname( plugin_basename( __FILE__ ) ) . '/lang/' );
        $widget_ops = array(
            'classname'   => 'widget_vkapi',
