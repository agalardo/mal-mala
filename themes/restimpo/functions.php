...
$restimpo_themever = "1.4.6";					//Theme version
...
function restimpo_scripts_styles() {
    ...
    wp_enqueue_script( 'restimpo-placeholders', get_template_directory_uri() . '/js/placeholders.js', array(), '3.0.2', true );
...
add_filter( 'excerpt_length', 'restimpo_custom_excerpt_length', 20 );
