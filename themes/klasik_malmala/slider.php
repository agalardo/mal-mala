						...
						if ($wp_query->have_posts()){
							...
							if(has_post_thumbnail( get_the_ID()) || $cf_thumb!=""){
								if($cf_thumb!=""){
									...
									$sliderthumbimgsrc = wp_get_attachment_image_src($postthumbnailid,'image-thumb-slider');
									$cf_thbslider = $sliderthumbimgsrc[0];
								}
							}elseif($cf_video!=''){
							...
							if($slidercount > 1){
								...
								$output .='<div class="slider-img" data-thumb="'.$cf_thbslider.'" data-src="'.$cf_bgslider.'">';
